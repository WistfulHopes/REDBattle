...
private:
    static const int32_t FuncCallArg_Num = 4; // 0xFFFFFFFFFFFFFFFF
    static const int32_t FuncCallArg_StackMax = 10; // 0xFFFFFFFFFFFFFFFF
    int32_t m_FuncCallArg[FuncCallArg_Num][FuncCallArg_StackMax]{}; // 0x3C8C
