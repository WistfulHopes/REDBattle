...
public:
    ...
    bool IsValid();
    bool IsCharaIDValid();
    void SetBattleCharaData(ECharaID charaID, EColorID colorID, EBattleScript scriptType, ECostumeID costumeID,
...
public:
    ...
    void LoadCharaData(uint8_t* charaBbs, uint32_t charaBbsSize, uint8_t* effBbs, uint32_t effBbsSize,
                       uint8_t* col, int idx);
