...
public:
    ...
    AA_Matrix(const AA_Vector3 EyePosition, const AA_Vector3 LookDirection, const AA_Vector3 UpVector)
    {
        ...
        AA_Vector3 vz = { EyePosition.X - LookDirection.X, EyePosition.Y - LookDirection.Y, EyePosition.Z - LookDirection.Z };
        ...
        AA_Vector3 vx = { UpVector.Y*vz.Z - UpVector.Z*vz.Y, UpVector.Z*vz.X - UpVector.X*vz.Z, UpVector.X*vz.Y - UpVector.Y*vz.X };
    ...
    {
        Rotator = AA_Rotator(Rotator.Pitch * (M_PI/180.0f), Rotator.Yaw * (M_PI/180.0f), Rotator.Roll * (M_PI/180.0f));
    ...
    AA_Matrix Mult(const AA_Matrix& Other) const
    {
        ...
        result.M[0][3] = M[0][0]*Other.M[0][3] + M[0][1]*Other.M[1][3] + M[0][2]*Other.M[0][1] + M[0][3]*Other.M[3][3];
